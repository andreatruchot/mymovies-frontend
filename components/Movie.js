...
function Movie(props) {
  ...
  // Construction de l'URL complète de l'image du poster
  const posterURL = baseURL + props.poster_path;
  // Tronque l'overview directement dans le rendu si nécessaire
  const truncatedOverview = props.overview.length > 250 ? props.overview.substring(0, 250) + "..." : props.overview;
  ...
  return (
    <div className={styles.card}>
      <img className={styles.image} src={posterURL} alt={props.title} />
